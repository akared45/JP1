...
import E7.Controller.AccountController;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n===== Accounts =====");
        Account accountByCode = accountController.getAccountByCustomerCode("ABCD123");
        ...
        List<Account> accountsByName = accountController.getAccountByCustomerName("Week");
        ...
        List<Account> maleAccounts = accountController.getAccountByCustomer();
        ...
        long femaleCount = accountController.countAccountByCustomer();
        if (femaleCount > 0) {
        ...
        Optional<Account> maxBalanceAccount = accountController.getMaxBalance();
